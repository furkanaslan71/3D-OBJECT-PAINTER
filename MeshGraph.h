...
class MeshGraph
{
    ...
    Color filtered(Color color, FilterType type, double alpha, double distance) const;
    double gaussian(double alpha, double distance) const;
    double box(double alpha, double distance) const;
    static bool compare(const Vertex* first, const Vertex* second);
